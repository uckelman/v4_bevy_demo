use bevy::{
    camera::Camera2d,
    ecs::children,
    prelude::{AlignItems, Commands, default, DespawnOnExit, FlexDirection, JustifyContent, Node, OrthographicProjection, Projection, Resource, SpawnRelated, Text, TextFont, Timer, TimerMode, Val}
};
